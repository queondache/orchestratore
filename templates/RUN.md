...
pipeline: <CI/deploy workflows checked after merge | none>
...
its merge SHA or a later one containing it, or `pipeline: none`) | waiting (PR needs the user) | parked (evidence + resume
condition below).
