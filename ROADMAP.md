...
Ultimo allineamento: 13/09/2026, versione 0.4.0.
...
| M2 | Agent del plugin e bridge verso l'altro runtime | **FATTO** | `agents/` (5 file), `bin/spawn-*.sh`, `tests/check-bridge.sh` verde, 19 controlli |
| M3 | Comandi slash e hook | **FATTO** | `commands/` (2 file), `hooks/hooks.json` + 2 script, `tests/check-hooks.sh` verde, 20 controlli |
